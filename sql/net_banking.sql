...
(1, 1, 'shashank@gmail.com', '984141', 12345678),
(2, 3, 'rahul@gmail.com', '98989898', 11223344);
...
(1, 'Shashank', 'Kumar', 'male', '1970-05-18', 12345, 'shashank@gmail.com', '984141', 'raipur', 'Kaveri Vihar', 12345678, 1234, 'shashank', 'password'),
(2, 'Riya', 'Shetty', 'female', '1985-12-28', 5555, 'riya@gmail.com', '9841414', 'bhubaneshwar', 'phase - A/2', 112233, 5678, 'riya', 'password'),
(3, 'Rahul', 'Awasthi', 'male', '2001-01-12', 11223344, 'rahul@gmail.com', '98989898', 'kolkata', 'sector - 5', 11223344, 9536, 'rahul', 'password');
...
(1, 'Hello World !', '2020-09-06 15:45:25'),
(2, 'The First News !', '2020-10-06 15:45:55'),
(3, 'Increasing Interest Rates !', '2020-11-06 15:46:21'),
(4, 'GST on banking', '2020-12-19 16:39:35'),
(5, 'RBI allows Global Bank customers to withdraw', '2021-01-27 21:07:12'),
(6, 'New Post', '2021-02-28 13:35:58');
...
(5, 'Delhi: The Reserve Bank of India (RBI) has eased the restrictions on depositors of Global Bank of India (GBI), two days after it put a Rs 1,000 cap on the money a saver could withdraw, triggering protests.\r\n\r\nA depositor in the customer based bank can withdraw up to Rs 10,000, the RBI said in a press release on Thursday.\r\n\r\nThis will allow more than 60% of the depositors withdraw their entire account balance, according to the central bankâ€™s calculation.\r\n\r\nThe Rs 1,000 cap was set on January 24, 2020. The RBI said it hiked the limit after an initial assessment of the bankâ€™s liquidity position by an administrator appointed by it.\r\n\r\nThe RBI said it had identified â€œmajor financial irregularities, failure of internal control and systems of the bank and wrong/under-reporting of its exposures under various off-site surveillanceâ€ that it conducted.'),
...
(1, '2020-09-27 21:00:06', 'Opening Balance', 0, 5000000, 5000000),
(2, '2020-11-27 21:09:38', 'Received from: Riya Shetty, AC/No: 112233', 0, 10000, 5010000),
(3, '2021-02-28 13:37:08', 'Received from: Riya Shetty, AC/No: 112233', 0, 50000, 5060000);
...
(1, '2020-12-27 21:05:28', 'Opening Balance', 0, 150000, 150000),
(2, '2020-12-27 21:09:38', 'Sent to: Shashank Kumar, AC/No: 12345678', 10000, 0, 140000),
(3, '2021-01-28 13:37:08', 'Sent to: Shashank Kumar, AC/No: 12345678', 50000, 0, 90000),
(4, '2021-02-28 13:37:25', 'Cash to Self', 10000, 0, 80000);
...
(1, '2020-012-28 13:35:27', 'Opening Balance', 0, 800000, 800000);
